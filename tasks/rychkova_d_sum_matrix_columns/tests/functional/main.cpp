...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<RychkovaDSumMatrixColumnsMPI, InType>(kTestParam, PPC_SETTINGS_rychkova_d_sum_matrix_columns),
                   ppc::util::AddFuncTask<RychkovaDSumMatrixColumnsSEQ, InType>(kTestParam, PPC_SETTINGS_rychkova_d_sum_matrix_columns));
