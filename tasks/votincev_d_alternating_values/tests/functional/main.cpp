...
TEST_P(VotincevDAlternatigValuesRunFuncTestsProcesses, MatmulFromPic) {
...
const auto kPerfTestName = VotincevDAlternatigValuesRunFuncTestsProcesses::PrintFuncTestName<VotincevDAlternatigValuesRunFuncTestsProcesses>;

INSTANTIATE_TEST_SUITE_P(PicMatrixTests, VotincevDAlternatigValuesRunFuncTestsProcesses, kGtestValues, kPerfTestName);
