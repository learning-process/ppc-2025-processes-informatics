...
Корень рассылает по step элементов на остальные процессы с помощью MPI_Scatterv, последний неполный блок оставляет себе.
...
| mpi         | 2     | 1.080   | 0.65    | 32.5%      |
| mpi         | 3     | 1.065   | 0.66    | 22%      |
| mpi         | 4     | 1.011   | 0.69    | 17.25%     |
