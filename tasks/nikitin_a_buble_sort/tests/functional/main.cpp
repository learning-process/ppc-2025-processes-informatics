...
class NikitinAFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_nikitin_a_buble_sort, "pic.jpg");
...
TEST_P(NikitinAFuncTests, MatmulFromPic) {
...
const auto kPerfTestName = NikitinAFuncTests::PrintFuncTestName<NikitinAFuncTests>;

INSTANTIATE_TEST_SUITE_P(PicMatrixTests, NikitinAFuncTests, kGtestValues, kPerfTestName);
