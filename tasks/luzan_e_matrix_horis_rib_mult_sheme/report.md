...
**Ограничения:**
- Элементы матрицы - целые числа в диапазоне `[0; 42000]`
- Элементы вектора - целые числа в диапазоне `[0; 4200]`
...
- **Данные:** 
	- Матрица 15 000 × 15 000,  элементы - целые числа от 0 до 4 200.
	- Вектор длины 15 000, элементы - целые числа от 0 до 42 000.
...
|-------------|-------|---------|---------|------------|
| seq         | 1     | 0.098   | 1.000   | N/A        |
| omp         | 2     | 1.045   | 0.094   | 4.69%      |
| omp         | 4     | 0.885   | 0.111   | 2.77%      |
