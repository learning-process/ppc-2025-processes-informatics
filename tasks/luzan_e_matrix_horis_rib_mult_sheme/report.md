...
- **Данные:** 
	- Матрица 12 500 × 12 500,  элементы - целые числа от 0 до 4 200.
	- Вектор длины 12 500, элементы - целые числа от 0 до 42 000.
...
|-------------|-------|---------|---------|------------|
| seq         | 1     | 0.108   | 1.00    | N/A        |
| omp         | 2     | 1.087   | 0.099   | 4.97%      |
| omp         | 4     | 1.013   | 3.107   | 2.67%      |
