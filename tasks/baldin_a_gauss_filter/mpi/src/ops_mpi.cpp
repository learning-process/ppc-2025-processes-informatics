...
bool BaldinAGaussFilterMPI::RunImpl() {
  ...
  MPI_Allgatherv(result_buffer.data(), my_real_rows * row_size_bytes, MPI_UINT8_T, GetOutput().pixels.data(),
                 recv_counts.data(), recv_displs.data(), MPI_UINT8_T, MPI_COMM_WORLD);
