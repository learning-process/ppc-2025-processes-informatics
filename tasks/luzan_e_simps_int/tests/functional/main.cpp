...
class LuzanESimpsIntFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
  static std::string PrintTestParam(const TestType &test_param) {
    ...
    std::string square = "square_" + std::to_string(a) + "_" + std::to_string(b) + "__" + std::to_string(c) + "_" + std::to_string(d);
...
const std::array<TestType, 15> kTestParam = {std::make_tuple(4, std::make_tuple(3, 5), std::make_tuple(3, 5), 1), // std
