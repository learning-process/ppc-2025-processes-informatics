...
Такой показатель используется при анализе упорядоченности данных и диагностике корректности сортировки.
...
- `MPI_Bcast` — рассылка результата всем процессам (требование PPC).
