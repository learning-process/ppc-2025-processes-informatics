...
- **Вычисления на каждом отдельно взятом процессе**
	...
	local_size - количество тех данных, которые нужно просуммировать каждому процессу
...
| omp  | 4     | 0.000505 | 0.477   | 11.925%    |
| omp  | 8     | 0.000638 | 0.377   | 4.712%     |
...
| omp  | 2     | 0.00557 | 0.45    | 22.5%      |
| omp  | 4     | 0.00588 | 0.426   | 10.65%     |
| omp  | 8     | 0.00645 | 0.389   | 4.862%     |
...
| omp  | 2     | 0.15131 | 0.157   | 7.854%     | 
| omp  | 4     | 0.16886 | 0.1407  | 3.519%     |
| omp  | 8     |    -    |   -     |   -        |
