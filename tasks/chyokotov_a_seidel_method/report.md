...
Наблюдается замедление с ростом числа процессов, а эффективность постепенно снижается из-за роста наклодных расходов для коммуникации между процессами. На каждой итерации необходимо синхронизировать вычисленные данные для последующей итерации что подтверждает оптимальность выбранной схемы распределения данных между процессами.
