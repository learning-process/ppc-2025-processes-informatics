...
В начале инициализируется переменные координаты глобального минимума и значения в точке глоабльного минимума. Для них выбирается наименьший по значению вариант из границ отрезка, на котором задана функция.
