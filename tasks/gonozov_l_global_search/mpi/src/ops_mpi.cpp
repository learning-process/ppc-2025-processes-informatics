...
bool GonozovLGlobalSearchMPI::RunImpl() {
  ...
  //   {
  //     t = global_max.rank;
  //     double newElemSequence = 0.5 * (testSequence[t] + testSequence[t - 1]) - 0.5 / m * (function(testSequence[t]) -
  //     function(testSequence[t - 1])); if (function(newElemSequence) < global_min_value) {
