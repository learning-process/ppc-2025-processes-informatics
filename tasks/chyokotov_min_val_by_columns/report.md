...
2. Распределяем равномерно столбцы между процессами.
...
- Environment: PPC_NUM_PROC = 6
- Data: Генерация матрицы 4000*4000.
...
|-------------|-------|---------|---------|------------|
| seq         | 1     | 1.7884  | 1.00    | N/A        |
| mpi         | 2     | 1.0655  | 1.68    | 83.9%      |
| mpi         | 4     | 0.5764  | 3.10    | 77.6%      |
| mpi         | 6     | 0.3731  | 4.79    | 79.9%      |

Наблюдается близкое к линейному ускорение с ростом числа процессов, а эффективность сохраняется на высоком уровне, что подтверждает оптимальность выбранной схемы распределения данных между процессами.
## 8. Conclusions
