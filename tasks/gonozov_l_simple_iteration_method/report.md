...
## 1. Введение
Метод простых итерации является достаточно востребованным методом, так как он может быть использован для решения систем линейных уравнений, что влечёт за собой многие прикладные области, например, такие как анализ электрических цепей. Для таких задач часто используется метод простой итерации — итерационный алгоритм нахождения приближённого решения.

Цель работы — реализовать параллельную версию метода простой итерации с использованием технологии MPI, оценить корректность работы и исследовать ускорение относительно последовательного варианта.
