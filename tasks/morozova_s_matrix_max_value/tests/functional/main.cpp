...
class MorozovaSRunFuncTestsProcesses : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  ...
  bool CheckTestOutputData(OutType &output_data) final {
    if (input_data_.empty()) return false;
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<MorozovaSMatrixMaxValueMPI, InType>(kTestParam, PPC_SETTINGS_morozova_s_matrix_max_value),
