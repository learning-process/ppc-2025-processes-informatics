...
Обе реализации (SEQ и MPI) дают одинаковый и ожидаемый ответ при при всех тестах.
---
...
|-------|----------------------|--------------|------------|---------------|
| SEQ   | 1                    | 0.0058619022 | 1.00       | N/A           |
| MPI   | 2                    | 0.0018719228 | 3.13       | 156.6%       |
| MPI   | 4                    | 0.0014312866 | 4.10       | 102.4%       |
