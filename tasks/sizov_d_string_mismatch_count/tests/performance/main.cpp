...
class SizovDRunPerfTestsStringMismatchCount
...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, SizovDStringMismatchCountMPI,
                                SizovDStringMismatchCountSEQ>(
        PPC_SETTINGS_sizov_d_string_mismatch_count);

const auto kGtestValues = ppc::util::TupleToGTestValues(kAllPerfTasks);
const auto kPerfTestName =
    SizovDRunPerfTestsStringMismatchCount::CustomPerfTestName;

TEST_P(SizovDRunPerfTestsStringMismatchCount, RunPerfModes) {
  ExecuteTest(GetParam());
}

INSTANTIATE_TEST_SUITE_P(RunPerf, SizovDRunPerfTestsStringMismatchCount,
