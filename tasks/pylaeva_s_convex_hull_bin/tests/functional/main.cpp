...
class PylaevaSConvexHullBinFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_pylaeva_s_convex_hull_bin, "pic.jpg");
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<PylaevaSConvexHullBinMPI, InType>(kTestParam, PPC_SETTINGS_pylaeva_s_convex_hull_bin),
...
INSTANTIATE_TEST_SUITE_P(PylaevaSConvexHullBin, PylaevaSConvexHullBinFuncTests, kGtestValues, kPerfTestName);
