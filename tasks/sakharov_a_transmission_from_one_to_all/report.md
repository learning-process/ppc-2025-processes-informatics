...
**Параметры запуска:**
- число процессов: n = 2, 4, 6; (`mpirun -n ${n} ...`);
...
|-------------|-------|---------|---------|------------|
| seq         | 1     | 0.009   | 1.00    | N/A        |
| mpi         | 2     | 0.068   | 0.13    | 6.5%       |
| mpi         | 4     | 0.095   | 0.09    | 2.25%      |
| mpi         | 6     | 0.120   | 0.075   | 1.25%      |

**Интерпретация:**
- Коммуникационные накладные расходы доминируют над дешёвыми вычислениями копирования, поэтому ускорения нет; скорость ухудшается при увеличении количества потоков.
