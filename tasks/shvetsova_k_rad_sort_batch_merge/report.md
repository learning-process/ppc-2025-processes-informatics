...
| :--- | :-------: | :-----: | :-----: | :--------: |
| SEQ  |     1     | 0.72464 |  1.00   |    100%    |
| MPI  |     1     | 0.73012 |  0.99   |    99%     |
| MPI  |     2     | 0.02709 |  26.75  |   1337%    |
| MPI  |     4     | 0.01520 |  47.67  |   1191%    |
| MPI  |     8     | 0.01140 |  63.56  |    794%    |

### 8.2 Discussion

Параллельная версия показывает суперлинейное ускорение (26.7x на 2 процессах). Основные причины:

-   **Кэш-память:** При разделении массива на части локальные данные каждого процесса начинают полностью помещаться в L2/L3 кэш процессора, что на порядки ускоряет работу поразрядной сортировки (LSD крайне чувствителен к скорости работы с памятью).
-   **Эффективность слияния:** Затраты на `MPI_Sendrecv` для 2 процессов минимальны по сравнению с выигрышем от локальной сортировки.
