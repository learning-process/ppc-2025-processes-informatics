...
class GusevDSentenceCountFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath("gusev_d_sentence_count", "pic.jpg");
...
TEST_P(GusevDSentenceCountFuncTests, MatmulFromPic) {
...
INSTANTIATE_TEST_SUITE_P(PicMatrixTests, GusevDSentenceCountFuncTests, kGtestValues, kPerfTestName);
