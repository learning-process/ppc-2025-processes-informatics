...
**Вывод:** На массиве объемом 10 млн элементов алгоритм показывает более высокую масштабируемость: на 4 процессах эффективность составила **60.0%** против **54.4%** на меньшем объеме. Это подтверждает, что при увеличении вычислительной сложности задачи выгода от параллельной обработки возрастает.
