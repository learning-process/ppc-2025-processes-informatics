# пока Скалярное произведение векторов потом переделать
...
- Data: Для замера производительности использовались векторы размером 20.000.000. Проводилась редукция с операцией суммирования целых чисел. Все элементы исходных векторов равны 1.
...
|-------------|-------|---------|---------|------------|
| seq         | 2     | 0.263   | 1.00    | N/A        |
| mpi         | 2     | 0.426   | TODO    | 2.75%      |
| seq         | 4     | 0.666   | 1.00    | N/A        |
| mpi         | 4     | 0.761   | TODO    | 4.5%       |
