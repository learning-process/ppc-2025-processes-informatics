...
Данная реализация является высоко оптимизированной и использует специализированные алгоритмы и низкоуровневые оптимизации, включая оптимизации для shared-memory архитектур при малом числе процессов.
