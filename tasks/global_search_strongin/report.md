...
* MPI (8 процессов): `mpiexec -n 8 ppc_perf_tests.exe --gtest_filter=*global_search_strongin_mpi_enabled*`

| Реализация | Процессов | Режим теста | Время, сек |
|-----------:|----------:|-------------|-----------:|
| seq        | 1         | pipeline    | 0.00664024 |
| seq        | 1         | task_run    | 0.00376224 |
| mpi        | 8         | pipeline    | 0.01854664 |
| mpi        | 8         | task_run    | 0.02621578 |
