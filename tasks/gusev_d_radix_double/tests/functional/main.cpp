...
const std::array<TestType, 15> kTestParams = {
    // 1. Базовые тесты
    std::make_tuple(10, "SmallVector"),
    std::make_tuple(100, "MediumVector"),
    std::make_tuple(500, "LargeVector"),
    std::make_tuple(0, "EmptyVector"),
    std::make_tuple(1, "SingleElement"),
    
    // 2. Специфические данные
    std::make_tuple(100, "PositiveVector"),
    std::make_tuple(100, "NegativeVector"),
    std::make_tuple(100, "SortedVector"),
    std::make_tuple(100, "ReverseSortedVector"),
    ...
    std::make_tuple(2048, "Size_2048_Pow2"),
    std::make_tuple(2500, "Size_2500"),
    std::make_tuple(5000, "Size_5000_MaxFunc")
};

const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<GusevDRadixDoubleSEQ, InType>(kTestParams, PPC_SETTINGS_gusev_d_radix_double),
