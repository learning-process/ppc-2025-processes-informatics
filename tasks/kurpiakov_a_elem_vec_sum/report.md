...
- Студент: <Last First Middle>, group <Group>
- Технологии: SEQ | MPI 
- Variant: 1
...
Тест6: вектор четной длины, такой что для любого v[i] существует v[j] = -v[i] (i != j)
...
Мнею не было получено ожидаемое ускорение в 8 раз. 
