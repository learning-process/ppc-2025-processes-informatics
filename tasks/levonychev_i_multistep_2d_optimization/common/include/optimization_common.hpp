...
struct Point {
  ...
  Point() = default;
  Point(double x_val, double y_val, double func_value) 
      : x(x_val), y(y_val), value(func_value) {}
...
inline Point LocalOptimization(const std::function<double(double, double)>& func,
...
inline std::vector<Point> SearchInRegion(const std::function<double(double, double)>& func,
