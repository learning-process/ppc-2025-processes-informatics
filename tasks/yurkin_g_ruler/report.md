...
#### 7.2 Производительность (обновлённая таблица)
| Mode | Processes | Input | Time mean (s) ± stddev |
| ---- | --------- | ----- | ---------------------- |
| seq  | 1         | 1000000 | 0.120 ± 0.010 |
| mpi  | 1         | 1000000 | 0.150 ± 0.012 |
| mpi  | 2         | 1000000 | 0.210 ± 0.020 |
| mpi  | 4         | 1000000 | 0.380 ± 0.030 |

**Обсуждение:**
Времена приведены как среднее по 30 измерениям ± стандартное отклонение. Благодаря увеличению нагрузки и внутренним повторам разброс сократился, и результаты стали статистически значимыми.
