...
const std::array<TestType, 19> kTestParam = {
    ...
    std::make_tuple(8, "power_of_two_small"),   std::make_tuple(15, "medium_odd"),
    std::make_tuple(16, "power_of_two_medium"), std::make_tuple(31, "prime_medium"),
    std::make_tuple(32, "power_of_two_large"),  std::make_tuple(50, "round_number_medium"),
    std::make_tuple(63, "odd_boundary"),        std::make_tuple(64, "power_of_two_boundary"),
    std::make_tuple(100, "round_number_large"), std::make_tuple(127, "prime_large"),
    std::make_tuple(255, "odd_large"),          std::make_tuple(256, "power_of_two_xlarge"),
