...
const auto kPerfParams = ppc::util::MakeAllPerfTasks<InType, TestTaskMPI, TestTaskSEQ>(
    PPC_SETTINGS_egashin_k_lexicographical_check
);

INSTANTIATE_TEST_SUITE_P(
    EgashinKLexCheckPerf, 
    EgashinKLexCheckPerfTest, 
    ppc::util::TupleToGTestValues(kPerfParams)
);
