...
## 8. Conclusions
- На 2 и 4 процессах: Параллельная программа работает медленнее, чем последовательная. Отправка больших кусков данных между процессами занимает больше времени, чем выигрыш от параллельных вычислений.
