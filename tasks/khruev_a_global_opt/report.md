...
Входные данные:
- границы области поиска: \( [-3, 3] \times [-3, 3] \);
- целевая функция: Функция Растригина
- параметр надежности \( r = 4 \);
- точность поиска \( \varepsilon = 1e-7 \);
- максимальное число итераций `max_iter = 6000`.

#### Время выполнения

| Режим | Процессы | Время, с | Ускорение | Эффективность |
|-----|---------|----------|-----------|---------------|
| SEQ | 1 | 0.8131435394 | 1.00 | 100% |
| MPI | 2 | 0.7399739870 | 1.10 | 55% |
| MPI | 3 | 0.6295771750 | 1.31 | 43% |
| MPI | 4 | 0.5137244502 | 1.58 | 39% |

Полученные результаты показывают, что при увеличении количества процессов производительность растет.
