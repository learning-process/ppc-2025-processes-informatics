...
4. Тестовые данные (`data`)
   - `matrix_3x3.txt` - квадратная матрица 3x3 содержит 1 максимальный элемент в конце
   - `matrix_5x5.txt` - квадратная матрица 5x5 содержит 1 максимальный элемент в середине
   - `matrix_100x100.txt` - квадратная матрица 100x100 содержит несколько максимальных элементов 
