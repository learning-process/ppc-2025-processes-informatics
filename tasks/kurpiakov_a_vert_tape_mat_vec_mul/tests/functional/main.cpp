...
const std::array<TestType, 10> kTestParam = {
    {std::make_tuple(std::make_tuple(0, std::vector<int>{}, std::vector<int>{}), "test1_empty",
     ...
     std::make_tuple(std::make_tuple(2, std::vector<int>{1, 2, 3, 4}, std::vector<int>{5, 6}),
                     "test3_2x2", std::vector<int64_t>{17, 39}),
     std::make_tuple(std::make_tuple(3, std::vector<int>{1, 0, 0, 0, 1, 0, 0, 0, 1},
                                     std::vector<int>{2, 3, 4}),
                     "test4_identity_3x3", std::vector<int64_t>{2, 3, 4}),
     std::make_tuple(std::make_tuple(2, std::vector<int>{0, 0, 0, 0}, std::vector<int>{1, 2}),
                     "test5_zero_matrix", std::vector<int64_t>{0, 0}),
     std::make_tuple(std::make_tuple(2, std::vector<int>{1, 2, 3, 4}, std::vector<int>{0, 0}),
                     "test6_zero_vector", std::vector<int64_t>{0, 0}),
     std::make_tuple(std::make_tuple(2, std::vector<int>{1, -2, -3, 4}, std::vector<int>{2, 1}),
                     "test7_negative_elements", std::vector<int64_t>{0, -2}),
     std::make_tuple(std::make_tuple(2, std::vector<int>{1000000, 2000000, 3000000, 4000000},
                                     std::vector<int>{500, 600}),
                     "test8_large_values", std::vector<int64_t>{1700000000, 3900000000}),
     std::make_tuple(std::make_tuple(3, std::vector<int>{2, 1, 1, 1, 2, 1, 1, 1, 2},
