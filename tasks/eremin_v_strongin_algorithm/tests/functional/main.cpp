...
const std::array<TestType, 6> kTestParam = {
    std::make_tuple(1, -1.0, 1.0, 1000, [](double x) { return x * x; }, 0.0),

    std::make_tuple(2, 0.0, 4.0, 5000, [](double x) { return (x - 2) * (x - 2); }, 2.0),

    std::make_tuple(3, 0.0, 4.0, 10000, [](double x) { return std::sin(x); }, 1.5 * M_PI),

    std::make_tuple(4, -3.0, 3.0, 20000, [](double x) { return x * x * x * x - 3 * x * x; }, std::sqrt(1.5)),

    std::make_tuple(5, -2.0, 2.0, 3000, [](double x) { return std::exp(x); }, -2.0),

    std::make_tuple(6, -5.0, 5.0, 50000, [](double x) { return std::sin(x) + 0.1 * x * x; }, -1.427)};
