...
Тестирование проводилось на массиве из **5 000 000** элементов для операции суммы (`task_run`, `pipeline`).
...
| Mode | Count | Time (s) | Speedup | Efficiency |
|------|-------|----------|---------|------------|
| seq  | 1 | 0.0016367 | 1.00 | – |
| mpi  | 2 | 0.0016457 | 0.99 | 0.50 |
| mpi  | 4 | 0.0010450 | 2.23 | 0.56 |
| mpi  | 6 | 0.0002622 | 6.24 | 1.04 |
