...
class KosolapovVCalcMultIntegralsMSimpsonFuncTestsProcesses
...
TEST_P(KosolapovVCalcMultIntegralsMSimpsonFuncTestsProcesses, CalcMultIntegralsMSimpson) {
...
const auto kTestTasksList = std::tuple_cat(ppc::util::AddFuncTask<KosolapovVCalcMultIntegralsMSimpsonMPI, InType>(
                                               kTestParam, PPC_SETTINGS_kosolapov_v_calc_mult_integrals_m_simpson),
                                           ppc::util::AddFuncTask<KosolapovVCalcMultIntegralsMSimpsonSEQ, InType>(
                                               kTestParam, PPC_SETTINGS_kosolapov_v_calc_mult_integrals_m_simpson));

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName = KosolapovVCalcMultIntegralsMSimpsonFuncTestsProcesses::PrintFuncTestName<
    KosolapovVCalcMultIntegralsMSimpsonFuncTestsProcesses>;

INSTANTIATE_TEST_SUITE_P(CalcMultIntegralsMSimpson, KosolapovVCalcMultIntegralsMSimpsonFuncTestsProcesses, kGtestValues,
                         kPerfTestName);
