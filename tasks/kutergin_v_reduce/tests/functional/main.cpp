...
{
    std::make_tuple(10, 0, "size_10_root_0"),
    std::make_tuple(20, 1, "size_20_root_1"),
    std::make_tuple(1, 3, "size_1_root_3"),
    std::make_tuple(100, 2, "size_100_root_2")
};

const auto kTestTasksList = std::tuple_cat(
    ppc::util::AddFuncTask<ReduceSequential, InType>(kTestCases, PPC_SETTINGS_kutergin_v_reduce),
