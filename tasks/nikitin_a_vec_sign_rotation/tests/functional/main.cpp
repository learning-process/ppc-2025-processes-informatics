...
class NikitinAVecSignRotationFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_nikitin_a_vec_sign_rotation, "pic.jpg");
...
TEST_P(NikitinAVecSignRotationFuncTests, MatmulFromPic) {
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<NikitinAVecSignRotationMPI, InType>(kTestParam, PPC_SETTINGS_nikitin_a_vec_sign_rotation),
...
INSTANTIATE_TEST_SUITE_P(PicMatrixTests, NikitinAVecSignRotationFuncTests, kGtestValues, kPerfTestName);
