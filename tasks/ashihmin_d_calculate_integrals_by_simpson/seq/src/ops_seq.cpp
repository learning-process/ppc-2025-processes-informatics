...
AshihminDCalculateIntegralsBySimpsonSEQ::AshihminDCalculateIntegralsBySimpsonSEQ(
    const InType& input) {
...
double AshihminDCalculateIntegralsBySimpsonSEQ::IntegrandFunction(
    const std::vector<double>& coordinates) {
  return Function(coordinates);
}

void AshihminDCalculateIntegralsBySimpsonSEQ::RecursiveIntegration(
    int dimension, std::vector<double>& coordinates, 
    const std::vector<double>& step_sizes, double& total_sum) {
