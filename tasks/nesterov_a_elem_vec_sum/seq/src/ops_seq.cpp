...
bool NesterovAElemVecSumSEQ::ValidationImpl() {
  return (GetInput() > 0) && (GetOutput() == 0);
}

bool NesterovAElemVecSumSEQ::PreProcessingImpl() {
  GetOutput() = 2 * GetInput();
  return GetOutput() > 0;
}

bool NesterovAElemVecSumSEQ::RunImpl() {
  if (GetInput() == 0) {
    return false;
  }
...
bool NesterovAElemVecSumSEQ::PostProcessingImpl() {
  GetOutput() -= GetInput();
  return GetOutput() > 0;
}
