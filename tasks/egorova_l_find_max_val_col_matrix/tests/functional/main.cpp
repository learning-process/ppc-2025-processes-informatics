...
TEST_P(EgorovaLRunFuncTestsProcesses, MatmulFromPic) {
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<EgorovaLFindMaxValColMatrixMPI, InType>(kTestParam, PPC_SETTINGS_example_processes),
...
INSTANTIATE_TEST_SUITE_P(PicMatrixTests, EgorovaLRunFuncTestsProcesses, kGtestValues, kPerfTestName);
