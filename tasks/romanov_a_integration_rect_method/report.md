...
| OMP   | 11              | 0.154    | 8.56      | 77.8%         |
| OMP   | 12              | 0.138    | 9.57      | 79.8%         |
| OMP   | 13              | 0.235    | 5.62      | 43.2%         |
| OMP   | 14              | 0.237    | 5.57      | 39.8%         |
...
В случае с двумя процессами код был достаточно хорошо оптимизирован компилятором, из-за чего его эффективность очень высока (при сравннении с иным числом процессов).
...
Потеря производительности при большем числе процессов чем 12 скорее всего происходит из-за частных смен контекста процессов и простоев.
## 8. Заключение
