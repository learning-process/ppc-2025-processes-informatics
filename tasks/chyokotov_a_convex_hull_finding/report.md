...
6. Построение выпуклых оболочек происходит в ConvexHullAndrew() как в последовательной версии с помощью векторного произведения реализованного в функции Cross()
...
|---------|-------|---------|---------|------------|
|   seq   |   1   | 0.9599  |  1.00   |    N/A     |
|   mpi   |   2   | 1.0133  |  0.95   |   47.4%    |
|   mpi   |   4   | 0.9687  |  0.99   |   24.8%    |
|   mpi   |   6   | 0.9545  |  1.01   |   16.8%    |
