...
n = 10'000'000
| Mode        | Count | Time, s | Slowdown | Efficiency |
|-------------|-------|---------|----------|------------|
...
По результатам из таблицы можно сделать вывод, что параллельная реализация неэффективна, так как параллельные версии работают медленее последовательной (замедление 0.81-0.51).
