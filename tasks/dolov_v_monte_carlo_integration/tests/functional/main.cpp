...
class DolovVMonteCarloIntegrationFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_dolov_v_monte_carlo_integration, "pic.jpg");
...
TEST_P(DolovVMonteCarloIntegrationFuncTests, MatmulFromPic) {
